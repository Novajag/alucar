            ...
            echo '
                <div class="col-md-4 m-4">
                    ...
                    <form action="http://localhost/dashboard/site/config/control.php" class="row" method="post">
                        ...
                        <input class="form-control col-md-12 me-2 m-2" type="text" name="velocidad" placeholder="Velocidad" aria-label="Search">
                        <input class="form-control col-md-12 me-2 m-2" type="text" name="Km" placeholder="Kilometraje" aria-label="Search">
                        <input class="form-control col-md-12 me-2 m-2" type="text" name="estado" placeholder="estado" aria-label="Search">
